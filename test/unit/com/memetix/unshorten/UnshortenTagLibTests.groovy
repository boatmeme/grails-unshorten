...
@TestFor(UnshortenTagLib)
@Mock(UnshortenTagLib)
class UnshortenTagLibTests  {
    ...
    void testExpandUrls() {
        ...
        assertEquals( 'On a more pleasant note, pets and kids in baskets are a very popular photo subject. I could make a collection. http://www.twitcaps.com/search?q=basket# http://www.the-grotto.com/tits.net http://www.twitcaps.com/search?q=dsk hahaha', 
    ...
    void testUnshortenUrl() {
        ...
        assertEquals( 'http://www.twitcaps.com/search?q=basket#', 
            applyTemplate(template) )
    }
    ...
    void testUnshortenAndLinkUrl() {
        ...
        assertEquals( '<a href="http://www.twitcaps.com/search?q=basket#">http://www.twitcaps.com/search?q=basket#</a>', 
            applyTemplate(template) )
    }
    ...
    void testUnshortenAndLinkUrlClass() {
        ...
        assertEquals( '<a class="myLinkClass" href="http://www.twitcaps.com/search?q=basket#">http://www.twitcaps.com/search?q=basket#</a>', 
            applyTemplate(template) )
    }
}
